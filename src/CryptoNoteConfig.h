...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x7b54; // addresses start with "2"
...
const char     CRYPTONOTE_NAME[]                             = "codeofcoin";
...
const int      P2P_DEFAULT_PORT                              =  26261;
const int      RPC_DEFAULT_PORT                              =  26262;
